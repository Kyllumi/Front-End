...
*/
let stringa1 = "questa è la prima stringa";
...
const arrayFiltrato = array2.filter((value) => value % 2 === 0);
...
*/
let array3 = array2.map((ele) => ele + 4);
console.log(array3);
...
*/
let strArray = ["questo", "è", "un", "array"];
let newStrArray = strArray.map((element) => element.length);
...
*/
let filmTitle = movies.map((element) => element.Title);
console.log(filmTitle);

/* ESERCIZIO 12 (filter)
  Scrivi una funzione per ottenere dall'array fornito solamente i film usciti nel millennio corrente.
*/
let newFilm = movies.filter((value) => value.Year >= 2000);
console.log(newFilm);

/* ESERCIZIO 13 (reduce)
  Scrivi una funzione per calcolare la somma di tutti gli anni in cui sono stati prodotti i film contenuti nell'array fornito.
*/
let totYear = movies.reduce((acc, value) => acc + +value.Year, 0);
console.log(totYear);
